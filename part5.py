...
if(month == "March" or month == "march" or month == "January" or month == "january" or month == "May" or month == "may" or month == "July" or month == "july" or month == "August" or month == "august" or month == "October" or month == "october" or month == "December" or month == "december"):
  print("31")
elif(month == "November" or month == "november" or month == "September" or month == "september" or month == "April" or month == "april" or month == "June" or month == "june"):
  print("30")
